...
function createHeaders(sourceXML){
  ...
  document.getElementById('globalIdDescr').innerText = sourceXML.getElementsByTagName('metadata')[0].children[2].innerHTML;

  document.getElementById('itemTitle').innerText = sourceXML.getElementsById('spatialUnit')[0].children[3].children[0].children[0].children[0].innerHTML;
